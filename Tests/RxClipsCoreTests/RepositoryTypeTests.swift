...
class RepositoryTypeTests: XCTestCase {
  ...
  func testScriptTypeBash() throws {
    ...
    if case .bash(let bashScript) = bashRepo.steps![0].script {
  ...
  func testScriptTypeJavascript() throws {
    ...
    if case .javascript(let javascriptScript) = javascriptRepo.steps![0].script {
  ...
  func testScriptTypeTemplate() throws {
    ...
    if case .template(let templateScript) = templateRepo.steps![0].script {
